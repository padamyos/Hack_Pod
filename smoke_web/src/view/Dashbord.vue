    ...
    <div class=" flex flex-row">
      ...
      <div
        ...
        <div class="flex h-fit w-full items-center justify-center gap-[1em] ">
          <svg viewBox="0 0 80 80" fill="none" height="80" width="80" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <div class="flex flex-col items-start justify-center">
            <p class="text-[0.75rem] font-light">po</p>
            <p class="text-[1.5em] font-semibold"> {{ latestTemperature }}°C</p>
            <div class="flex items-center justify-center gap-[0.125em]">
              <svg viewBox="0 0 16 17" fill="none" height="17" width="16" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 14.26A5.92 5.92 0 1 0 8 2.42a5.92 5.92 0 0 0 0 11.84Z" stroke-linejoin="round"
                  stroke-linecap="round" stroke="#F471A6"></path>
                <path
        ...
        <div class="flex h-fit w-full items-center justify-between">
            ...
            <div class="flex flex-row items-center justify-center gap-[0.5em] p-[0.25em]">
              <svg viewBox="0 0 16 16" fill="none" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                <path
                  ...
                  stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" stroke="#999"></path>
              </svg>
          ...
          <div class="flex h-full w-[6rem] flex-col items-center py-[0.25em] text-[0.625em]">
            <div class="group relative z-0 h-[48px] w-[48px]">
              <svg class="duration-200 ease-linear group-hover:-translate-y-[8px]" viewBox="0 0 48 48" fill="none"
                ...
                <g>
                  ...
                  <path
                    ...
                    fill="#5EAC24"></path>
                  <path d="M35.813 17.311H13.348l2.944 22.913h16.25l3.271-22.913Z" fill="#4E901E"></path>
                  <path
                  ...
                  <path
                    ...
                    fill="#5EAC24"></path>
                  <path d="M13.544 12.699a4.547 4.547 0 1 0 0-9.093 4.547 4.547 0 0 0 0 9.093Z" fill="#6DC82A"></path>
                  <path
                  ...
                  <path
                    ...
                    fill="#57565C"></path>
                  <path d="M34.449 12.699a4.547 4.547 0 1 0 0-9.094 4.547 4.547 0 0 0 0 9.094Z" fill="#6DC82A"></path>
                  <path
              ...
              <span
                class="absolute bottom-[8px] left-1/2 z-[-1] h-[4px] w-[32px] -translate-x-1/2 bg-[#68082e] blur-[6px] duration-200 ease-linear group-hover:w-[16px] group-hover:blur-[4px]"></span>
            </div>
